...
helm repo update
helm install nocodb k8s-at-home/nocodb
```
...
```console
helm install nocodb k8s-at-home/nocodb -f values.yaml
```
...
|-----|------|---------|-------------|
| env | object | See below | environment variables. See more environment variables in the [nocodb documentation](https://nocodb.org/docs). |
